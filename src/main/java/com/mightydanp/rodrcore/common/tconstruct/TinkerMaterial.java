...
public class TinkerMaterial {
    public static HashMap<String, CTinkersMaterialHandler> materials = new HashMap<String, CTinkersMaterialHandler>(){{
        ...
        putIfAbsent("Titanium", new CTinkersMaterialHandler(501, "titanium", 650, 1500, 2, 25, 1.5f, 6.5F, 5, 6, 0.0f, EnumChatFormatting.GRAY.toString(), 0xFF73787E, "ingotTitanium", 1, false, 2, 0, 0));
