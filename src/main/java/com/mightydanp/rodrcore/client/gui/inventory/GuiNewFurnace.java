...
public class GuiNewFurnace extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int x, int y) {
		...
		this.fontRendererObj.drawString(Integer.toString(tileEntityFurnace.temprature), 93 - this.fontRendererObj.getStringWidth(guiName) / 2, 61, 4210752);
	...
	protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
		...
		if (this.tileEntityFurnace.isBurning()) {
			...
			if (this.tileEntityFurnace.furnaceCookTime > 0) {
